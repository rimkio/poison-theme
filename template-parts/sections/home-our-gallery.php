...
<section class="section section-our-gallery">
    <div class="container">
        ...
        <div class="row section-our-gallery__row">
            <div class="col-lg-5 " data-aos="fade-up" data-aos-duration="500">
                ...
                <div class="section-our-gallery__grid" id="thumbnails-gallery" >
                    <?php if ($gallery) { ?>
                        <?php foreach ($gallery as $key => $item) { ?>
                            <a class="section-our-gallery__grid-item" data-aos="fade-up" data-aos-duration="500" href="<?= $item['url'] ?>"><img src="<?= $item['sizes']['thumnail-gallery'] ?>" alt="<?= $item['alt'] ?>" title="<?= $item['alt'] ?>" /></a>
                        <?php } ?>
                    <?php } ?>
                </div>
            </div>
