...
<div class="poison-shop__sidebar-inner">
    ...
    <div class="poison-shop__sidebar-part poison-shop__sidebar-type">
    ...
    <div class="poison-shop__sidebar-part poison-shop__sidebar-featured">
        <h6 class="poison-shop__sidebar-heading">SẢN PHẨM NỖI BẬT</h6>
        <div class="wrap-toggle poison-shop__sidebar-listproduct">
            <?php if (!empty($product_ids_ft)) { ?>
                <?php poison_list_product_sidebar($product_ids_ft); ?>
            <?php } else { ?>
                <p>Xin lỗi, không có bài phù hợp tiêu chí của bạn.</p>
            <?php } ?>
        </div>
    </div>

    <div class="poison-shop__sidebar-part poison-shop__sidebar-sales">
