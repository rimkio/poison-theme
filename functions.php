...
require get_template_directory() . '/resources/functions/ajax.php';
...
require get_template_directory() . '/resources/functions/shortcodes.php';
require get_template_directory() . '/resources/functions/custom-product.php';
