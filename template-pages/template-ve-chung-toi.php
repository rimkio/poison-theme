...
<div id="page-ve-chung-toi">
		...
		<div class="container">
			...
			<div class="breadcrumb">
				...
				<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
					<path d="M9.375 5.625L7.5 0L5.625 5.625L0 7.5L5.625 9.375L7.5 15L9.375 9.375L15 7.5L9.375 5.625ZM7.5 8.775C6.825 8.775 6.225 8.25 6.225 7.5C6.225 6.825 6.75 6.225 7.5 6.225C8.175 6.225 8.775 6.75 8.775 7.5C8.775 8.175 8.175 8.775 7.5 8.775Z" fill="#D02028"/>
				</svg>
				<h3>giới thiệu</h3>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<svg xmlns="http://www.w3.org/2000/svg" width="205" height="17" viewBox="0 0 205 17" fill="none">
						...
						<rect x="1.41421" y="8.89933" width="9.31359" height="9.31359" transform="rotate(-45 1.41421 8.89933)" stroke="#D02028" stroke-width="2"/>
					</svg>
					<p>
						<?= $content; ?>
					</p>
					<a href="<?= $link_xem_san_pham; ?>">Xem sản phẩm</a>
				</div>
				<div class="col-md-6">
					<img src="<?= $image_ve_poison_cafe; ?>"/>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="section-4">
		<div class="container-fluid">
			<div class="row">
				<?= do_shortcode('[nguon_nguyen_lieu_shortcode]');?>
			</div>
		</div>
	</div>
</div>
