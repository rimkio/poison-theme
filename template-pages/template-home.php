        ...
        <div class="container">
            <div class="home-hero__inner">
                <?php if (isset($logo) && !empty($logo)) : ?>
                    <img data-aos="fade-in" data-aos-duration="500" src="<?= $logo['url'] ?>" alt="<?= $logo['alt'] ?>">
                <?php endif; ?>

                <?php if (isset($welcome) && !empty($welcome)) : ?>
                    <span data-aos="fade-in" data-aos-duration="500" class="home-hero__inner-welcome"><?= $welcome ?></span>
                <?php endif; ?>

                <?php if (isset($heading) && !empty($heading)) : ?>
                    <h1 data-aos="fade-in" data-aos-duration="500" class="home-hero__inner-heading"><?= $heading ?></h1>
                <?php endif; ?>
                <span data-aos="fade-in" data-aos-duration="500" class="line-hero"><img src="<?= get_template_directory_uri() . '/resources/assets/images/line.svg' ?>" alt=""></span>
                <?php if (isset($slogan) && !empty($slogan)) : ?>
                    <p data-aos="fade-in" data-aos-duration="500" class="home-hero__inner-slogan"><?= $slogan ?></p>
                <?php endif; ?>
