...
add_action('after_setup_theme', function () {
	register_nav_menus([
		'main-menu'   => esc_html__('Primary', 'poison'),
		'footer-menu' => esc_html__('Footer Menu', 'poison'),
		'terms-menu'  => esc_html__('Terms Menu', 'poison'),
		'discover-menu'  => esc_html__('Discover Menu', 'poison')
	]);
});
...
function poison_wp_nav_menu_objects($items, $args)
{
...
add_filter('wp_nav_menu_objects', 'poison_wp_nav_menu_objects', 10, 2);
